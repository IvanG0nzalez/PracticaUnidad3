...
//                        paisController.getGrafo().obtenerEtiqueta(i+1) + " - " + paisController.getGrafo().caminoMinimoDijkstra(cbxPaisOrigen.getSelectedIndex() + 1).obtener(i));
                texto.append( " " + paisController.getGrafo().obtenerEtiqueta(i+1) + " - " + paisController.getGrafo().caminoMinimoDijkstra(cbxOrigenAlgoritmos.getSelectedIndex() + 1).obtener(i) + "\n");
